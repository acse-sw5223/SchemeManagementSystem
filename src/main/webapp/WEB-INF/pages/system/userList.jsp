		...
		<form class="form-inline" id="searchForm" action="${adminPath}/user?method=list" method="post">
			<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo }">
				...
				<label for="exampleInputName2">用户名</label>
					<input type="text" class="form-control" name="username" id="username" placeholder="请输入用户名" value="${username}"">
				</div>
				<div class="form-group">
				<label for="exampleInputName2">昵称</label>
					<input type="text" class="form-control" name="name" id="name" placeholder="请输入昵称" value="${name}"">
				</div>
				<div class="form-group">
			...
			<tbody>
				<c:forEach items="${page.list }" var="user" varStatus="num">
					<tr>
						...
						<td>
							<img src="${user.picture}" alt="" style="width: 50px;height: 50px" class="img-circle">
						</td>
						<td>
							${fns:dictLable('sex', user.sex)}
						</td>
						<td>
							${user.phone}
						</td>
